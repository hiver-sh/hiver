    ...
    SandboxConfig: {
      ...
      properties: {
        ...
        cpu: {
          ...
          default: 1,
          description:
            "Number of virtual CPUs allocated to the sandbox (microvm: guest vCPU count; container: enforced as a CPU quota). Cannot be changed after the sandbox is initialized.",
          examples: [1],
        },
        memory: {
          type: "integer",
