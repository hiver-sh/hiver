...
bundle-sandbox-images: ## Bundle and push the default sandbox images (multi-arch)
	...
	hiver bundle ./docker/antigravity --tag hiversh/antigravity:latest --push --platform $(PLATFORMS)
...
bundle-microvm-sandbox-images: ## Bundle and push the microvm sandbox images (multi-arch)
	...
	hiver bundle ./docker/antigravity --tag hiversh/antigravity:latest-microvm --push --platform $(PLATFORMS)
